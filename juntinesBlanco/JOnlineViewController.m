...
#import "JOnlineViewController.h"
#import "WebOnlineDosViewController.h"

@interface JOnlineViewController ()

@end

@implementation JOnlineViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/online/tiendas-online/juguetes";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"juguetesOnline"]) {
