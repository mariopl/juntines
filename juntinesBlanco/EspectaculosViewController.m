...
#import "EspectaculosViewController.h"
#import "WebCalleDosViewController.h"

@interface EspectaculosViewController ()

@end

@implementation EspectaculosViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/espectaculos";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"espectaculos"]) {
