...
#import "CDecoracionViewController.h"
#import "WebCalleDosViewController.h"

@interface CDecoracionViewController ()

@end

@implementation CDecoracionViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/tiendas/decoracion";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"decoracion"]) {
