...
#import "PintarViewController.h"
#import "WebOnlineViewController.h"

@interface PintarViewController ()

@end

@implementation PintarViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/online/pintar";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"pintar"]) {
