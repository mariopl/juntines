...
#import "JHabilidadViewController.h"
#import "WebOnlineDosViewController.h"

@interface JHabilidadViewController ()

@end

@implementation JHabilidadViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/online/juegos-online/de-habilidad";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"juegosHabilidad"]) {
