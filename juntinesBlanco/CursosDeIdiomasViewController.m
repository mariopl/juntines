//
//  CursosDeIdiomasViewController.m
//  juntinesBlanco
//
...
#import "CursosDeIdiomasViewController.h"
#import "WebCalleDosViewController.h"

@interface CursosDeIdiomasViewController ()

@end

@implementation CursosDeIdiomasViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/idiomas";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"cursosDeIdiomas"]) {
