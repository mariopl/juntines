//
//  RestaurantesViewController.m
//  juntinesBlanco
//
//  Created by Mario Pierre-Louis Marín on 24/03/13.
//  Copyright (c) 2013 Mario Pierre-Louis Marín. All rights reserved.
//

#import "RestaurantesViewController.h"
#import "WebCalleDosViewController.h"

@interface RestaurantesViewController ()

@end

@implementation RestaurantesViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/restaurantes";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"restaurantes"]) {
