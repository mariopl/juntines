...
#import "ManualidadesViewController.h"
#import "WebCasaDosViewController.h"

@interface ManualidadesViewController ()

@end

@implementation ManualidadesViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/casa/manualidades";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"manualidades"]) {
