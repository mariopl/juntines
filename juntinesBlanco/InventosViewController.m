...
#import "InventosViewController.h"
#import "WebCasaDosViewController.h"

@interface InventosViewController ()

@end

@implementation InventosViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    if ([segue.identifier isEqualToString:@"inventos"]) {
