...
#import "TalleresViewController.h"
#import "WebCalleViewController.h"

@interface TalleresViewController ()

@end

@implementation TalleresViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/talleres";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"talleres"]) {
