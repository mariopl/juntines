...
#import "TematicosViewController.h"
#import "WebCalleDosViewController.h"

@interface TematicosViewController ()

@end

@implementation TematicosViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/parques-tematicos";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"tematicos"]) {
