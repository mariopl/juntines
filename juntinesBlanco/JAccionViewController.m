...
#import "JAccionViewController.h"
#import "WebOnlineDosViewController.h"

@interface JAccionViewController ()

@end

@implementation JAccionViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/online/juegos-online/de-accion";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"JuegosAccion"]) {
