...
#import "JEducativosViewController.h"
#import "WebOnlineViewController.h"

@interface JEducativosViewController ()

@end

@implementation JEducativosViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/online/juegos-online/educativos";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"educativos"]) {
