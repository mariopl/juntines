...
#import "CocinaViewController.h"
#import "WebCasaViewController.h"

@interface CocinaViewController ()

@end

@implementation CocinaViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/casa/recetas";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"cocina"]) {
