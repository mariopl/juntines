...
#import "DOnlineViewController.h"
#import "WebOnlineViewController.h"

@interface DOnlineViewController ()

@end

@implementation DOnlineViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/online/tiendas-online/decoracion";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"decoracionOnline"]) {
