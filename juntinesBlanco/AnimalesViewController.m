...
#import "AnimalesViewController.h"
#import "WebCalleViewController.h"

@interface AnimalesViewController ()

@end

@implementation AnimalesViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/parques-tematicos/animales";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"animales"]) {
