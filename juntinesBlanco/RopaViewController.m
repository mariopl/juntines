...
#import "RopaViewController.h"
#import "WebCalleViewController.h"

@interface RopaViewController ()

@end

@implementation RopaViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/tiendas/ropa";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"ropa"]) {
