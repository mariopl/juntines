...
#import "ParqueViewController.h"
#import "WebCalleViewController.h"

@interface ParqueViewController ()

@end

@implementation ParqueViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/parques";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
   
    if ([segue.identifier isEqualToString:@"parques"]) {
