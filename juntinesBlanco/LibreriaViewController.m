...
#import "LibreriaViewController.h"
#import "WebCalleDosViewController.h"

@interface LibreriaViewController ()

@end

@implementation LibreriaViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/calle/tiendas/librerias";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"librerias"]) {
