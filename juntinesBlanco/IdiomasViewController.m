...
#import "IdiomasViewController.h"
#import "WebOnlineViewController.h"

@interface IdiomasViewController ()

@end

@implementation IdiomasViewController
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSString *url1 = @"http://www.juntines.com/online/aprender-idiomas";
    NSURLRequest *request1 = [NSURLRequest requestWithURL:[NSURL URLWithString:url1]];
    
    if ([segue.identifier isEqualToString:@"idiomas"]) {
